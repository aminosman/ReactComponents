...
exports.default = (function (props) {
    ...
    var search = function (query) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setLoading(true);
                    return [4 /*yield*/, props.onSearch(query)];
                case 1:
                    result = _a.sent();
    ...
    return (react_1.default.createElement(react_bootstrap_typeahead_1.AsyncTypeahead, { isLoading: loading, options: options, onChange: onChange, promptText: "Type to search...", minLength: 0, defaultInputValue: props.initialValue, onSearch: search, onInputChange: onInputChange }));
});

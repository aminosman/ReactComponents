...
exports.default = (function (props) {
    ...
    return (react_1.default.createElement(react_bootstrap_typeahead_1.AsyncTypeahead, { multiple: props.multiple, isLoading: props.loading || loading, options: props.options || options, onChange: onChange, promptText: "Type to search...", minLength: 0, defaultInputValue: props.initialValue, onSearch: search, onInputChange: onInputChange, selected: props.selected }));
});

...
var TableLoader = function (props) {
    ...
    var renderRowContents = function (item, snapshot) {
        ...
        if ((props === null || props === void 0 ? void 0 : props.onClick) && props.clickType === 'link') {
            ...
            rows.push(props.schema.map(function (i) { return React.createElement(TableCell, { snapshot: snapshot, id: String(i.key || i.property), key: "row-prop-data-" + String(i.key || i.property) }, renderItemProp(i, item)); }));
        }
        if (props.onUpdate) {
    ...
    var renderRow = function (item, index) { return (React.createElement(react_beautiful_dnd_1.Draggable, { key: item.id, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) { return (React.createElement(React.Fragment, null,
        React.createElement("tr", (0, tslib_1.__assign)({ className: "bg-gradient-dark text-white", key: "row-data-" + index + "-" + item.id, ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { style: provided.draggableProps.style }), renderRowContents(item, snapshot)),

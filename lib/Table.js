...
var TableLoader = function (props) {
    ...
    var renderRowContents = function (item, snapshot) {
        ...
        if ((props === null || props === void 0 ? void 0 : props.onClick) && props.clickType === 'link') {
            ...
            rows.push(props.schema.map(function (i) { return (React.createElement(TableCell, { cellClassName: props.cellClassName, snapshot: snapshot, id: String(i.key || i.property), key: "row-prop-data-" + propKey + "-" + String(i.key || i.property) },
                renderItemProp(i, item),
                (item.children || []).map(function (c) { return renderRowContents(c, snapshot); }))); }));
        }
        if (props.onUpdate) {

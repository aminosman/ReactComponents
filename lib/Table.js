...
var TableLoader = function (props) {
    ...
    var handleRemove = function (item) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            if (!props.onRemove)
                return [2 /*return*/];
            if (window.confirm("Are you sure you want to remove " + (item.name || item[props.schema[0].property] || '') + "?")) {
                props.onRemove(item);
            }
            return [2 /*return*/];
        });
    ...
    var renderField = function (item, i) {
        ...
        if (item.CustomComponent && typeof item.CustomComponent === 'function')
            return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "editLabel", key: item.label + "-label" },
                React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),
                React.createElement(item.CustomComponent, { onChange: function (e) { return onEditValueChange(item.key || item.property, e); }, item: editingField.item })));
    ...
    var renderItemProp = function (i, item) {
        var _a, _b;
        return "" + (typeof i.value === 'function' ? i.value(item) : (i === null || i === void 0 ? void 0 : i.extractor) ? (_b = (_a = i.extractor) === null || _a === void 0 ? void 0 : _a.call(i, (0, path_value_1.resolveValue)(item, "" + i.property))) === null || _b === void 0 ? void 0 : _b.value : booleanParser((0, path_value_1.resolveValue)(item, "" + i.property))) + (i.units ? ' ' + i.units(item) : '');
    };

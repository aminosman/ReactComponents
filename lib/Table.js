...
var TableLoader = function (props) {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setEditing(item ? props.schema.map(function (itemSchema) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, itemSchema), { value: getOrignalVlaue(item, itemSchema), item: item })); }) : null);
                    setShowModal(true);
                    return [2 /*return*/];
            }
        });
    ...
    var renderField = function (item, i) {
        ...
        if (item.CustomComponent && typeof item.CustomComponent === 'function')
            return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "editLabel", key: item.label + "-label" },
                React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),
                React.createElement(item.CustomComponent, { onChange: function (e) { return onEditValueChange(item.key || item.property, e); }, item: editingField.value })));
        ...
        console.warn({ type: type, editingField: editingField, item: item });
        switch (type) {
            case 'select':

...
var TableLoader = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (item)
            setEditing(props.schema.map(function (itemSchema) {
                var _a;
                var value = ((_a = editing === null || editing === void 0 ? void 0 : editing.find(function (e) { return e.property === (itemSchema === null || itemSchema === void 0 ? void 0 : itemSchema.property); })) === null || _a === void 0 ? void 0 : _a.value) || getOriginalValue(item, itemSchema);
    ...
    var renderField = function (item, i) {
        ...
        var currentItem = editing === null || editing === void 0 ? void 0 : editing.reduce(function (p, c) {
            var _a;
            return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, p), (_a = {}, _a[c.property] = c.value, _a)));
        }, {});
        if (!editingField)
            return null;
        ...
        var type = typeof item.type === 'function' ? (_a = item.type) === null || _a === void 0 ? void 0 : _a.call(item, currentItem) : item.type || 'text';
        switch (type) {
            case 'select':

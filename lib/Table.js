...
var TableLoader = function (props) {
    ...
    var renderField = function (item, i) {
        ...
        switch (type) {
                ...
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-info-" + String(item.key || item.property) + "-" + type },
                    ...
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(Form_1.default.Control, { disabled: item.editable === false, as: "select", required: item.required, value: "" + ((_c = (_b = item === null || item === void 0 ? void 0 : item.extractor) === null || _b === void 0 ? void 0 : _b.call(item, editingField.value)) === null || _c === void 0 ? void 0 : _c.key), onChange: function (e) {
                                var _a;
                                var _options = (item.itemBasedOptions && ((_a = item.itemBasedOptions) === null || _a === void 0 ? void 0 : _a.call(item, currentField))) || (optionsMap === null || optionsMap === void 0 ? void 0 : optionsMap.get(item.property));
            ...
            case 'number':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-info-" + String(item.key || item.property) + "-" + type },
                    React.createElement(Form_1.default.Label, { className: "text-white" },
                        item.label, "" + !!("" + editingField.value).trim()),
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(Form_1.default.Control, { required: item.required, type: type, value: editingField.value !== null ? item.type === 'number' ? editingField.value
                                : "" + editingField.value : '', onChange: function (e) { return onEditValueChange(item.key || item.property, e.target.value); }, disabled: item.editable === false, isInvalid: !("" + editingField.value).trim() }),
    ...
    var renderItemPropContents = function (i, item) {
        ...
        return React.createElement(React.Fragment, null,
            typeof i.value === 'function' ? i.value(item) : (i === null || i === void 0 ? void 0 : i.extractor) ? (_b = (_a = i.extractor) === null || _a === void 0 ? void 0 : _a.call(i, (0, path_value_1.resolveValue)(item, "" + i.property), item)) === null || _b === void 0 ? void 0 : _b.value : booleanParser((0, path_value_1.resolveValue)(item, "" + i.property)),
            " ",

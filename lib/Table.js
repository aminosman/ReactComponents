...
var TableLoader = function (props) {
    ...
    var renderRow = function (item, index, schema) {
        var _a;
        if ((_a = item.children) === null || _a === void 0 ? void 0 : _a.length)
            debugger;
        return (React.createElement(react_beautiful_dnd_1.Draggable, { key: "draggable-row-" + item.id + "-" + propKey, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) {
            var _a, _b;
            return (React.createElement(React.Fragment, null,

...
var TableLoader = function (props) {
    ...
    var handleRemove = function (item) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            if (!props.onRemove)
                return [2 /*return*/];
            if (window.confirm("Are you sure you want to remove " + (item.name || item[props.schema[0].property] || ((_b = (_a = props.schema[0]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.call(_a, item)) || '') + "?")) {
                props.onRemove(item);
            }
            return [2 /*return*/];
        });

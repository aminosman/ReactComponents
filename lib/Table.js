...
var TableLoader = function (props) {
    ...
    var renderRowContents = function (item, snapshot) {
        ...
        if ((props === null || props === void 0 ? void 0 : props.onClick) && props.clickType === 'link') {
            ...
            rows.push(props.schema.map(function (i) {
                var _a;
                return (React.createElement(React.Fragment, null,
                    React.createElement(TableCell, { cellClassName: props.cellClassName, snapshot: snapshot, id: String(i.key || i.property), key: "row-prop-data-" + propKey + "-" + String(i.key || i.property) }, renderItemProp(i, item)),
                    Array.isArray(item.children) && (React.createElement("tr", null,
                        React.createElement("td", { colSpan: (_a = props.schema) === null || _a === void 0 ? void 0 : _a.length },
                            React.createElement("table", { className: "table mb-0" }, (item.children || []).map(function (c) { return renderRowContents(c, snapshot); })))))));
            }));
        }
        if (props.onUpdate) {
    ...
    var renderRow = function (item, index) { return (React.createElement(react_beautiful_dnd_1.Draggable, { key: "draggable-row-" + item.id + "-" + propKey, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) { return (React.createElement(React.Fragment, null,

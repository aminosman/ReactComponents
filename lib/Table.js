...
var TableLoader = function (props) {
    ...
    var renderRowContents = function (item, snapshot, schema) {
        var rows = [];
    ...
    var renderRow = function (item, index, schema) { return (React.createElement(react_beautiful_dnd_1.Draggable, { key: "draggable-row-" + item.id + "-" + propKey, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) {
        var _a, _b;
        return (React.createElement(React.Fragment, null,
            React.createElement("tr", (0, tslib_1.__assign)({ className: "bg-gradient-dark text-white " + (props.rowClassName || ''), key: "row-data-" + index + "-" + item.id + "-" + propKey, ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { style: provided.draggableProps.style }), renderRowContents(item, snapshot, schema)),
            Array.isArray(item.children) && !!((_a = item.children) === null || _a === void 0 ? void 0 : _a.length) && !!props.nestedSchema && (React.createElement("tr", null,
                React.createElement("td", { colSpan: (_b = props.schema) === null || _b === void 0 ? void 0 : _b.length },
                    React.createElement("table", { className: "table mb-0" }, Array.isArray(props.nestedSchema) && renderTable(item.children, props.nestedSchema))))),
    ...
    var renderTable = function (itemsToRender, schema) { return (React.createElement(react_beautiful_dnd_1.DragDropContext, { onDragEnd: handleDragEnd },
        React.createElement(react_beautiful_dnd_1.Droppable, { droppableId: "droppable", isDropDisabled: !props.onDragEnd }, function (provided, snapshot) { return (React.createElement("table", { ref: provided.innerRef, className: "table table-hover table-dark " + props.tableClassName },
            ...
            React.createElement("tbody", null,
                props.loading ? renderLoadingTable() : itemsToRender.map(function (item, index) { return renderRow(item, index, schema); }),
                provided.placeholder))); }))); };
    return (React.createElement(React.Fragment, null,

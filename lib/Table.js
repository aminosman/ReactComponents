...
var TableLoader = function (props) {
    ...
    var renderField = function (item, i) {
        ...
        console.warn({ editingField: editingField, item: item });
        if (!editingField)
            return null;
        ...
        switch (item.type) {
            case 'select':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-infor-" + String(item.key || item.property) },
                    React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),
                    React.createElement(Form_1.default.Control, { disabled: item.editable === false, as: "select", required: item.required, value: "" + ((_b = (_a = item === null || item === void 0 ? void 0 : item.extractor) === null || _a === void 0 ? void 0 : _a.call(item, editingField.value)) === null || _b === void 0 ? void 0 : _b.key), onChange: function (e) {
            ...
            case 'checkbox':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-infor-" + String(item.key || item.property) },
                    ...
                    React.createElement(Form_1.default.Check, { className: "form-control-lg text-white", required: item.required, type: item.type, label: item.label, checked: editingField.value, onChange: function (e) { return onEditValueChange(item.key || item.property, e.target.checked); }, disabled: item.editable === false }),
                    React.createElement(Form_1.default.Control.Feedback, { type: "invalid" }, "This feild is required.")));
            case 'table':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-infor-" + String(item.key || item.property) },
                    React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),

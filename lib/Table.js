        ...
        switch (type) {
            ...
            case 'number':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-info-" + String(item.key || item.property) + "-" + type },
                    React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(Form_1.default.Control, { required: item.required, type: type, value: editingField.value !== null
                                ? item.type === 'number'
                                    ? editingField.value
                                    : "" + editingField.value
            ...
            case 'table':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-info-" + String(item.key || item.property) + "-" + type },
                    ...
                    item.props && (React.createElement(TableLoader, (0, tslib_1.__assign)({}, item.props, { title: typeof item.props.title === 'function'
                            ? (_h = (_g = item.props).title) === null || _h === void 0 ? void 0 : _h.call(_g, currentField)
                            : item.props.title, items: editingField === null || editingField === void 0 ? void 0 : editingField.value, onCreate: function (id, object) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                            ...
                            return (0, tslib_1.__generator)(this, function (_c) {
                                if (editing) {
                                    ...
                                    onEditValueChange(item.key || item.property, (subItemList === null || subItemList === void 0 ? void 0 : subItemList.length)
                                        ? (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (_b = subItemList === null || subItemList === void 0 ? void 0 : subItemList.filter) === null || _b === void 0 ? void 0 : _b.call(subItemList, function (x) { return x.id !== id; }), true), [updatedValue_1], false) : [updatedValue_1]);
                                }
                                return [2 /*return*/, true];
                            });
                        }); } })))));

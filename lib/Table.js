    ...
    var renderRowContents = function (item, snapshot) {
        ...
        if ((props === null || props === void 0 ? void 0 : props.onClick) && props.clickType === 'link') {
            ...
            rows.push(props.schema.map(function (i) {
                var _a;
                return (React.createElement(TableCell, { cellClassName: props.cellClassName, snapshot: snapshot, id: String(i.key || i.property), key: "row-prop-data-" + propKey + "-" + String(i.key || i.property) },
                    renderItemProp(i, item),
                    Array.isArray(item.children) && (React.createElement("td", { colSpan: (_a = props.schema) === null || _a === void 0 ? void 0 : _a.length },

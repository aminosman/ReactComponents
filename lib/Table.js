...
var TableLoader = function (props) {
    ...
    var renderRow = function (item, index) {
        console.log(item);
        return (React.createElement(react_beautiful_dnd_1.Draggable, { key: "draggable-row-" + item.id + "-" + propKey + "-" + props.loading, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) { return (React.createElement(React.Fragment, null,

...
var TableLoader = function (props) {
    ...
    var renderRowContents = function (item, snapshot, schema, cellClassName) {
        ...
        (_a = props.customActions) === null || _a === void 0 ? void 0 : _a.map(function (cA) { return (React.createElement(TableCell, { snapshot: snapshot, key: "row-prop-data-" + propKey + "-update-" + JSON.stringify(item) }, cA(item))); });
        if (props.onUpdate) {

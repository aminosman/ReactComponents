...
var TableLoader = function (props) {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setEditing(props.schema.map(function (itemSchema) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, itemSchema), { value: getOrignalVlaue(item, itemSchema), item: item })); }));
                    setShowModal(true);
                    return [2 /*return*/];
            }
        });
    ...
    var renderField = function (item, i) {
        ...
        var type = typeof item.type === 'function' ? editingField.item ? (_a = item.type) === null || _a === void 0 ? void 0 : _a.call(item, editingField.item) : 'text' : item.type;
        switch (type) {
            case 'select':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-infor-" + String(item.key || item.property) },
                    ...
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(Form_1.default.Control, { disabled: item.editable === false, as: "select", required: item.required, value: "" + ((_c = (_b = item === null || item === void 0 ? void 0 : item.extractor) === null || _b === void 0 ? void 0 : _b.call(item, editingField.value)) === null || _c === void 0 ? void 0 : _c.key), onChange: function (e) {
                                var _a;
                                var _options = (editingField.item && item.itemBasedOptions && ((_a = item.itemBasedOptions) === null || _a === void 0 ? void 0 : _a.call(item, editingField.item))) || (optionsMap === null || optionsMap === void 0 ? void 0 : optionsMap.get(item.property));
                            ...
                            renderOptions(item.property, editingField.item && item.itemBasedOptions ? (_d = item.itemBasedOptions) === null || _d === void 0 ? void 0 : _d.call(item, editingField.item) : undefined)),
            ...
            case 'number':
                return (React.createElement(Form_1.default.Group, { as: Col_1.default, controlId: "" + item.property, key: "form-infor-" + String(item.key || item.property) },
                    React.createElement(Form_1.default.Label, { className: "text-white" }, item.label),
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(Form_1.default.Control, { required: item.required, type: type, value: editingField.value !== null ? item.type === 'number' ? editingField.value
                                : "" + editingField.value : '', onChange: function (e) { return onEditValueChange(item.key || item.property, e.target.value); }, disabled: item.editable === false }),
    ...
    var renderItemPropContents = function (i, item) {
        ...
        return React.createElement(React.Fragment, null,
            typeof i.value === 'function' ? i.value(item) : (i === null || i === void 0 ? void 0 : i.extractor) ? (_b = (_a = i.extractor) === null || _a === void 0 ? void 0 : _a.call(i, (0, path_value_1.resolveValue)(item, "" + i.property))) === null || _b === void 0 ? void 0 : _b.value : booleanParser((0, path_value_1.resolveValue)(item, "" + i.property)),
            " ",
    ...
    var renderRow = function (item, index, schema, cellClassName) { return (React.createElement(react_beautiful_dnd_1.Draggable, { key: "draggable-row-" + (item.id || item.title || item.dateCreated) + "-" + propKey, draggableId: "" + item.id, index: index, isDragDisabled: !props.onDragEnd }, function (provided, snapshot) {
        var _a, _b;
        return (React.createElement(React.Fragment, null,
            React.createElement("tr", (0, tslib_1.__assign)({ className: "bg-gradient-dark text-white " + (props.rowClassName || ''), ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { style: provided.draggableProps.style, key: "row-data-" + index + "-" + item.id + "-" + propKey }), renderRowContents(item, snapshot, schema, cellClassName)),
